...
import riskyken.lighting.common.tileentities.TileEntityStarLight;
import cpw.mods.fml.common.registry.GameRegistry;
import cpw.mods.fml.relauncher.Side;
import cpw.mods.fml.relauncher.SideOnly;

public class BlockStarLight extends AbstractModBlock implements
        ITileEntityProvider {
    ...
    public void randomDisplayTick(World world, int x, int y, int z, Random rnd) {
        ...
        if (te != null & te instanceof TileEntityStarLight) {
            ...
            for (int i = 0; i < 5; i++) {
                ...
                if (renderState == 0) {
                    // Particles.STAR_DUST.spawnParticle(world, particleX,
                    // particleY, particleZ, x + 0.5F, y + 0.5F, z + 0.5F,
                    // true);
                }

                if (renderState == 2) {
                    // Particles.STAR_FLAME.spawnParticle(world, x + 0.5F, y +
                    // 0.5F, z + 0.5F, 0, 0, 0, true);
                }
            }
