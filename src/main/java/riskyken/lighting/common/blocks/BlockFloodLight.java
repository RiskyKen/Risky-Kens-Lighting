...
import riskyken.lighting.common.BlockFloodLightTypes;
import riskyken.lighting.common.items.block.ModItemBlockWithMetadata;
...
public class BlockFloodLight extends AbstractModBlock implements
        ITileEntityProvider {
    ...
    public void registerBlockIcons(IIconRegister register) {
        ...
        blockSideIcons[0] = register.registerIcon(LibModInfo.ID + ":"
                + "device-block-3");
        blockSideIcons[1] = register.registerIcon(LibModInfo.ID + ":"
                + "device-block-4");

        blockFaceIcons = new IIcon[10];
        blockFaceIcons[0] = register.registerIcon(LibModInfo.ID + ":"
                + "flood-light-1-on");
        blockFaceIcons[1] = register.registerIcon(LibModInfo.ID + ":"
                + "flood-light-2-on");
        blockFaceIcons[2] = register.registerIcon(LibModInfo.ID + ":"
                + "flood-light-3-on");
        blockFaceIcons[3] = register.registerIcon(LibModInfo.ID + ":"
                + "flood-light-4-on");
        blockFaceIcons[4] = register.registerIcon(LibModInfo.ID + ":"
                + "flood-light-5-on");

        blockFaceIcons[5] = register.registerIcon(LibModInfo.ID + ":"
                + "flood-light-1-off");
        blockFaceIcons[6] = register.registerIcon(LibModInfo.ID + ":"
                + "flood-light-2-off");
        blockFaceIcons[7] = register.registerIcon(LibModInfo.ID + ":"
                + "flood-light-3-off");
        blockFaceIcons[8] = register.registerIcon(LibModInfo.ID + ":"
                + "flood-light-4-off");
        blockFaceIcons[9] = register.registerIcon(LibModInfo.ID + ":"
                + "flood-light-5-off");
    }
    ...
    public void onBlockPlacedBy(World world, int x, int y, int z,
        ...
        int facing = BlockPistonBase.determineOrientation(world, x, y, z,
                entityLivingBase);
        TileEntity te = world.getTileEntity(x, y, z);
        if (te != null && te instanceof TileEntityFloodLight) {
            ((TileEntityFloodLight) te).setBlockFacing(
                    ForgeDirection.getOrientation(facing), false);
        }
    }
    ...
    public IIcon getIcon(IBlockAccess iBlockAccess, int x, int y, int z,
        ...
        if (te != null && te instanceof TileEntityFloodLight) {
            return ((TileEntityFloodLight) te).getIconForSide(side,
