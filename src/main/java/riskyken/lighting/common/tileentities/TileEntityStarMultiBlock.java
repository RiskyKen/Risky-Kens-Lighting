...
public class TileEntityStarMultiBlock extends TileEntity {
    ...
    private void checkForStar1() {
        if (!checkForActiveBurnners(xCoord, yCoord, zCoord, 1)) {
            return;
        }

        removeBurnners(xCoord, yCoord, zCoord, 1);
        worldObj.setBlock(xCoord, yCoord, zCoord, ModBlocks.starLight, typeId,
                2);
        System.out.println("found star 1");
    }

    private void checkForStar2() {
        if (!checkForLayer1(xCoord, yCoord, zCoord)) {
            return;
        }
        if (!checkForActiveBurnners(xCoord, yCoord, zCoord, 2)) {
            return;
        }
    ...
    private void checkForStar4() {
        ...
        if (!checkForActiveBurnners(xCoord, yCoord, zCoord, 3)) {
            return;
        }
    ...
    private boolean checkForLayer1(int x, int y, int z) {
        if (!checkMultiBlockMeta(x, y + 1, z, 6)) {
            return false;
        }
        if (!checkMultiBlockMeta(x, y - 1, z, 6)) {
            return false;
        }
        if (!checkMultiBlockMeta(x + 1, y, z, 6)) {
            return false;
        }
        if (!checkMultiBlockMeta(x - 1, y, z, 6)) {
            return false;
        }
        if (!checkMultiBlockMeta(x, y, z + 1, 6)) {
            return false;
        }
        if (!checkMultiBlockMeta(x, y, z - 1, 6)) {
            return false;
    ...
    private boolean checkForActiveBurnners(int x, int y, int z, int offset) {
        if (!checkMultiBlockMeta(x, y + offset, z, 5)) {
            return false;
        }
        if (!checkMultiBlockMeta(x, y - offset, z, 5)) {
            return false;
        }
        if (!checkMultiBlockMeta(x + offset, y, z, 5)) {
            return false;
        }
        if (!checkMultiBlockMeta(x - offset, y, z, 5)) {
            return false;
        }
        if (!checkMultiBlockMeta(x, y, z + offset, 5)) {
            return false;
        }
        if (!checkMultiBlockMeta(x, y, z - offset, 5)) {
            return false;
    ...
    private boolean checkMultiBlockMeta(int x, int y, int z, int meta) {
        if (worldObj.getBlock(x, y, z) != ModBlocks.starMultiBlock) {
            return false;
        }
        if (worldObj.getBlockMetadata(x, y, z) != meta) {
            return false;
        }
        return true;
    }
