...
public enum BlockStarLightTypes {
    ...
    MINI_STAR(0, 8, "Mini Star", false), STAR(1, 16, "Star", false), NOVA_STAR(
            2, 32, "Nova Star", false), PULSAR_STAR(3, 64, "Pulsar Star", false);
    ...
    public void addHoverText(List hoverText) {
        hoverText.add("Lights up a radius of " + lightRadius
                + " blocks around it.");
    }
